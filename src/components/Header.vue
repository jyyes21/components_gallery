<template>  
        <div class="relative flex flex-wrap items-center justify-between bg-white group py-7 shrink-0 w-5/6 mx-auto">
                <div class="flex items-center text-[40px] font-[500]">
                    <img class="h-20" src="../../public/favicon.ico">
                    <h1 class="leading-[32px]">Components <br>
                        Gallery
                    </h1>
                </div>
                <div class="items-center justify-between hidden gap-12 text-black md:flex">
                    <a class="text-sm font-normal text-dark-grey-700 hover:text-dark-grey-900" href="javascript:void(0)">Component</a>
                    <a class="text-sm font-normal text-dark-grey-700 hover:text-dark-grey-900" href="javascript:void(0)">Premuim</a>
                    <a class="text-sm font-normal text-dark-grey-700 hover:text-dark-grey-900 cursor-not-allowed" href="">Tools</a>
                    <a class="text-sm font-normal text-dark-grey-700 hover:text-dark-grey-900 cursor-not-allowed" href="">Tools</a>
                </div>
